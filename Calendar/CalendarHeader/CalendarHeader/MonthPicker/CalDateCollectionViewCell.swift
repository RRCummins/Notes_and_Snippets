//
//  CalDateCollectionViewCell.swift
//  CalendarHeader
//
...
class CalDateCollectionViewCell: UICollectionViewCell {
  ...
  static let reuseIdentifier = String(describing: CalDateCollectionViewCell.self)
...
// MARK: - Appearance
private extension CalDateCollectionViewCell {
