...
struct ExpenseStatus {
    var date: String
    var name: String
    var completionStatus: Bool
}

//var eventExpense = Event(ID: <#T##String#>)

var data: [ExpenseStatus] = [ExpenseStatus(date: "05/05/2021", name: "Netflix", completionStatus: false),
                             ExpenseStatus(date: "04/25/2021", name: "Hulu", completionStatus: true),
                             ExpenseStatus(date: "05/02/2021", name: "HBO Max", completionStatus: true),
                             ExpenseStatus(date: "05/01/2021", name: "Disney+", completionStatus: true),
                             ExpenseStatus(date: "05/25/2021", name: "Hulu", completionStatus: false),
                             ExpenseStatus(date: "04/22/2021", name: "Paramount", completionStatus: true),
                             ExpenseStatus(date: "05/31/2021", name: "Amazon Prime", completionStatus: false),
                             ExpenseStatus(date: "05/10/2021", name: "Apple TV", completionStatus: false),
]

class KVKCalViewController: UIViewController {
...
extension KVKCalViewController: CalendarDelegate {
...
extension KVKCalViewController: CalendarDataSource {
...
extension KVKCalViewController {
...
extension KVKCalViewController: UIPopoverPresentationControllerDelegate { }
