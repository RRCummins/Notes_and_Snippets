...
final class NotificationsViewController: UIViewController {
    ...
    private let tableView:UITableView = {
        ...
        tableView.register(NotificationLikeEventTableViewCell.self,
                           forCellReuseIdentifier: NotificationLikeEventTableViewCell.indentifier)
        tableView.register(NotificationFollowEventTableViewCell.self,
                           forCellReuseIdentifier: NotificationFollowEventTableViewCell.indentifier)
        return tableView
    }()
...
extension NotificationsViewController: NotificationLikeEventTableViewCellDelegate {
    func didTapRelatedPostButton(model: UserNotification) {
        ...
        case .follow(_):
            fatalError("Dev Issue, should never have been called")
        }
        // Open the Post
